<template>
  <div>
      ...
      <div class="container-image">
        ...
        <div class="shadow-image">
          <div class="flex flex-col items-center">
            <p class="ml-2 mb-2 text-lg">Collaborative Photo-culling App</p>
            <p class="ml-3 text-5xl">Select the best shots, <strong>together</strong></p>
          </div>
        </div>
      </div>
    </div>
    <div class="container-cols-2 lg:grid-cols-2 mx-24 mt-36">
      <div class="border border-solid border-r-0 border-violet-500">
        <img src="/teamwork.webp" alt="headshot" class="w-full h-fit" />
      </div>
      <!-- </div> -->
      <ul class="p-16 pt-24 text-sm sm:text-md md:text-xl flex flex-col gap-4 bg-violet-700">
        ...
        <li class="flex gap-3 items-center">
          ...
          <div>
            Select from
            <strong class="md:text-lg xl:text-xl 2xl:text-2xl">hundreds of photos</strong>?
          </div>
        </li>
        <li class="flex gap-3 items-center">
          ...
          <div class="w-full">
            Communicate
            <strong class="md:text-lg xl:text-xl 2xl:text-2xl">back and forth</strong> with
            <div class="lg:truncate lg:text-ellipsis lg:overflow-hidden xl:flex xl:items-baseline">
              <span
                v-for="(
                  letter, i
                ) in 'clients, editors, creative director, art directors, designer, team members'"
                :key="i"
                :style="{
                  fontSize: 1.25 - i * 0.01 + 'rem',
                }"
              >
                {{ letter }}
              </span>
        ...
        <li class="flex gap-3 items-center">
          <font-awesome-icon icon="fa-solid fa-check" class="text-xl" />
          <div>
            Chain yourself to an
            <strong class="md:text-lg xl:text-xl 2xl:text-2xl">overkill workstation</strong> all
            day?
          </div>
        </li>
        <li class="flex gap-3 items-center">
          <font-awesome-icon icon="fa-solid fa-check" class="text-xl" />
          <div>
            <strong class="md:text-lg xl:text-xl 2xl:text-2xl">Pay</strong> for collaborative review
            tools?
          </div>
        </li>
      </ul>
    ...
    <div class="container-cols-2 my-12">
      <div class="container-collabs md:pr-0">
      ...
      <div class="flex md:justify-center items-center border border-solid">
        <div>
    ...
    <div class="w-full flex justify-center px-12 py-4 text-violet-500 text-xl">
      <p class="text-white">
